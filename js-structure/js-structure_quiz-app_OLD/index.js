...
function Form() {
  ...
  const formFields = form.querySelectorAll('[data-js="input"]'); // sternchen entfernt
  const counterOutputs = form.querySelectorAll("[data-js=amount-left]"); // sternchen entfernt

  // in konstante gespeichert, damit es exportiert werden kann (richtig?)
  const styleFormFields = formFields.forEach((formField, index) => {
...
export { Form, formFields, counterOutputs, styleFormFields };
// *********************************************************************************
function Header() {
